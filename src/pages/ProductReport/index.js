...
import { productReporData } from '../../helpers/chartData';

function ProductReport() {
  const [productReporDimensions, setProductReportDimensions] = useState(null);
  return (
    <View style={styles.container}>
      ...
      <View style={styles.reportContainer}>
        ...
        <View
          ...
          style={[
            styles.reportChart,
            productReporDimensions
              ? styles.reportChartWithData
              : styles.reportChartWithoutData,
          ]}
        >
          <CustomLineChart
            chartData={productReporData}
            chartDimensions={productReporDimensions}
          />
        </View>
